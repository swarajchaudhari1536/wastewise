...
function TiltCard({
  ...
  const handleMouseMove = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      c.style.transform = `perspective(800px) rotateY(${x * 8}deg) rotateX(${-y * 8
  ...
  return (
    <div ref={ref} className="reveal-scale">
      <TiltCard className="h-full">
        <div className="group relative h-full bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700 shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden">
          <div
            className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-[0.04] dark:group-hover:opacity-[0.1] transition-opacity duration-500`}
          />
          <div className="relative z-10">
            <div
              className={`w-14 h-14 ${feature.bg} dark:bg-slate-800 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500`}
            >
            ...
            <div className="mt-6 flex items-center gap-2 text-sm font-semibold text-emerald-600 dark:text-emerald-400 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
  ...
  return (
    <div ref={ref} className="reveal-scale relative group text-center">
      <div className="relative mx-auto w-16 h-16 mb-6">
        <div className="absolute inset-0 bg-emerald-100 dark:bg-emerald-900/40 rounded-2xl rotate-6 group-hover:rotate-12 transition-transform duration-500" />
        <div className="relative w-full h-full bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-emerald-100 dark:border-emerald-800/50 flex items-center justify-center group-hover:shadow-lg group-hover:border-emerald-200 dark:group-hover:border-emerald-700 transition-all duration-500">
      ...
      <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed max-w-[260px] mx-auto">
        {step.desc}
      </p>
    </div>
  );
...
function TestimonialCard({
  ...
  return (
    <div ref={ref} className="reveal-scale">
      <div className="group relative h-full bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-xl hover:border-emerald-100 dark:hover:border-emerald-800 transition-all duration-500">
        <div className="absolute top-6 right-6 text-6xl font-serif text-emerald-100 dark:text-emerald-900/30 leading-none select-none group-hover:text-emerald-200 dark:group-hover:text-emerald-800/40 transition-colors duration-300">
          &ldquo;
        </div>
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-emerald-500/20 dark:shadow-emerald-500/10">
              {t.author
                .split(" ")
                .map((n) => n[0])
                .join("")}
            ...
            <div>
              <p className="font-bold text-slate-900 dark:text-slate-100 text-sm">{t.author}</p>
...
function HeroSection() {
  ...
  return (
    ...
    >
          ...
          {Array.from({ length: 30 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                animation: `particleFall ${Math.random() * 8 + 6
                  }s linear infinite`,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[4.5rem] pb-24 lg:pb-0 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[calc(100vh-4.5rem)]">
          ...
          <div className="py-12 lg:py-0">
            ...
            <h1 className="mb-6">
              {["Intelligent", "Urban"].map((word, i) => (
                <span key={word} className="inline-block overflow-hidden mr-3">
                  <span
                    className={`inline-block text-4xl sm:text-5xl lg:text-[3.5rem] xl:text-6xl font-extrabold leading-[1.1] tracking-tight transition-all duration-700 ${loaded
              ...
              <span className="inline-block overflow-hidden">
                <span
                  className={`relative inline-block text-4xl sm:text-5xl lg:text-[3.5rem] xl:text-6xl font-extrabold leading-[1.1] tracking-tight transition-all duration-700 ${loaded
                    ? "translate-y-0 opacity-100 blur-0"
                    : "translate-y-full opacity-0 blur-sm"
                    }`}
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-2 left-0 h-3 sm:h-4 bg-yellow-400/30 rounded-full transition-all duration-1000 ease-out ${loaded ? "w-full" : "w-0"
                      }`}
            ...
            {/* Sub */}
            <p
              className={`text-lg sm:text-xl text-emerald-50/90 mb-10 max-w-lg leading-relaxed transition-all duration-700 ${loaded
                ? "opacity-100 translate-y-0"
            ...
            {/* CTAs */}
            <div
              className={`flex flex-col sm:flex-row gap-4 mb-12 transition-all duration-700 ${loaded
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-6"
                }`}
            ...
            {/* Social proof */}
            <div
              className={`flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 transition-all duration-700 ${loaded
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-6"
                }`}
          ...
          {/* ═══ RIGHT — 3D cards ═══ */}
          <div
            className={`relative hidden lg:flex items-center justify-center min-h-[560px] transition-all duration-1000 ${loaded
          ...
          >
            ...
            <div
              style={p(-15)}
              className={`absolute -top-4 -right-2 z-30 transition-all duration-1000 ${loaded
            ...
            <div
              style={p(25)}
              className={`absolute -bottom-2 -left-6 z-30 transition-all duration-1000 ${loaded
                ? "opacity-100 translate-y-0 translate-x-0"
                : "opacity-0 translate-y-8 -translate-x-8"
                }`}
            >
            ...
            <div
              style={p(-12)}
              className={`absolute top-[45%] -left-12 z-30 transition-all duration-1000 ${loaded
                ? "opacity-100 translate-x-0"
            ...
            <div
              style={p(18)}
              className={`absolute bottom-[25%] -right-6 z-30 transition-all duration-1000 ${loaded
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-12"
                }`}
            >
      ...
      {/* Scroll indicator */}
      <div
        className={`absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 transition-all duration-700 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white dark:bg-slate-950">
      ...
      {/* ════ TRUSTED BY ════ */}
      <section className="py-5 bg-slate-50/80 dark:bg-slate-900/50 border-y border-slate-100 dark:border-slate-800 overflow-hidden">
      ...
      <section className="py-20 sm:py-28 bg-white dark:bg-slate-950 relative">
        ...
        >
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {stats.map((stat, i) => (
              <TiltCard key={i}>
                <div className="relative group bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-xl hover:border-emerald-200 dark:hover:border-emerald-700 transition-all duration-500 text-center overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 dark:from-emerald-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <div className="relative z-10">
                    <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-emerald-50 dark:bg-emerald-900/40 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                      <stat.icon className="h-7 w-7 text-emerald-600 dark:text-emerald-400" />
                    </div>
                    <p className="text-4xl sm:text-5xl font-extrabold text-emerald-600 dark:text-emerald-400 mb-2">
                      <AnimatedCounter
                        target={stat.value}
                        suffix={stat.suffix}
                      />
      ...
      {/* ════ FEATURES ════ */}
      <section className="py-20 sm:py-28 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-emerald-100/40 dark:bg-emerald-900/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-violet-100/30 dark:bg-violet-900/20 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4" />

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={r2} className="reveal text-center mb-16 sm:mb-20">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-900/30 rounded-full text-sm font-semibold text-emerald-700 dark:text-emerald-400 mb-6">
              <Zap className="h-4 w-4" />
              Features
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-slate-100 mb-5 tracking-tight">
      ...
      <section className="py-20 sm:py-28 bg-white dark:bg-slate-950 relative overflow-hidden">
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-teal-50 dark:bg-teal-900/20 rounded-full blur-3xl -translate-x-1/2" />
        <div className="absolute right-0 bottom-0 w-[300px] h-[300px] bg-emerald-50 dark:bg-emerald-900/20 rounded-full blur-3xl translate-x-1/3" />

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={r3} className="reveal text-center mb-16 sm:mb-20">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-teal-50 dark:bg-teal-900/30 rounded-full text-sm font-semibold text-teal-700 dark:text-teal-400 mb-6">
      ...
      {/* ════ TESTIMONIALS ════ */}
      <section className="py-20 sm:py-28 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-emerald-50 dark:bg-emerald-900/20 rounded-full blur-3xl translate-x-1/3 translate-y-1/3" />
        <div className="absolute top-0 left-0 w-[350px] h-[350px] bg-amber-50/50 dark:bg-amber-900/20 rounded-full blur-3xl -translate-x-1/4 -translate-y-1/4" />

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={r5} className="reveal text-center mb-16">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-amber-50 dark:bg-amber-900/30 rounded-full text-sm font-semibold text-amber-700 dark:text-amber-400 mb-6">
